...
export default function QuickListModal() {
  ...
  return (
    <>
      ...
      >
        <ListIcon className="h-5 w-5 sm:h-6 sm:w-6" />
        {totalItems > 0 && (
          <span className="absolute -right-0.5 -top-0.5 flex h-4 w-4 items-center justify-center rounded-full bg-brand-pink text-[10px] font-bold text-white sm:-right-1 sm:-top-1 sm:h-5 sm:w-5 sm:text-[11px]">
